...
//     { id: "preview", label: "Preview", icon: <FiLayout /> },
//   ];
...
//         className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-opacity-90"
//       >
...
//                     className={`relative z-10 px-6 py-3 rounded-full flex items-center justify-center transition-colors ${
//                       activeTab === tab.id
//                         ? "text-indigo-600"
...
//                 className="absolute top-0 left-0 h-full bg-white rounded-full shadow-md"
//                 initial={false}
//                 animate={{
...
//                   >
//                     <div className="w-24 h-24 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden border-2 border-white shadow-lg">
//                       <span className="text-3xl text-indigo-600 font-bold">
//                         JD
//                       </span>
//                     </div>
//                     <button className="absolute bottom-0 right-0 bg-indigo-600 text-white p-2 rounded-full shadow-md transform translate-y-1/4 group-hover:translate-y-0 transition-transform">
//                       <FiEdit size={16} />
//                     </button>
//                   </motion.div>
//                   <div>
...
//                           Cancel
//                         </button>
//                         <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-blue-600 text-white hover:from-indigo-700 hover:to-blue-700 transition-colors shadow-md">
//                           Save Changes
//                         </button>
//                       </div>
//                     </motion.div>
...
//                   <div className="flex justify-between items-center p-4 hover:bg-white hover:shadow-sm rounded-lg transition-all">
//                     <div>
...
//                       </h4>
//                       <p className="text-sm text-gray-600">
//                         Send email when login happens from new device
//                       </p>
//                     </div>
//                     <button
//                       onClick={() =>
...
//                   <div className="flex justify-between items-center p-4 pt-4 border-t border-gray-200 hover:bg-white hover:shadow-sm rounded-lg transition-all">
//                     <div>
//                       <h4 className="font-semibold text-gray-800">
//                         Manage Devices
//                       </h4>
...
//                         First Name
//                       </label>
//                       <div className="p-4 bg-white rounded-xl border-2 border-gray-200 font-medium">
//                         Afriyle
//                       </div>
//                     </div>
//                     <div>
...
//                   <div>
//                     <h4 className="font-semibold text-gray-800 mb-4">Gender</h4>
//                     <div className="grid grid-cols-3 gap-4">
