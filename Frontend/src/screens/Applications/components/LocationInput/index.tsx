...
// import { FiMapPin, FiRefreshCw, FiChevronDown, FiX } from "react-icons/fi";
...
// // Enhanced Ghana regions data with additional metadata
// const ghanaRegionsData: Record<
//   string,
//   {
//     cities: string[];
//     capital: string;
...
//   },
//   // ... other regions with similar enhanced data
// };
...
//     setRegion(val);
//     register("region").onChange({ target: { value: val } });
//     setIsRegionOpen(false);
//   };

//   const handleCitySelect = (val: string) => {
//     register("city").onChange({ target: { value: val } });
//     setCityInput(val);
//     setIsCityOpen(false);
//   };
...
//                   {
//                     Object.entries(ghanaRegionsData).find(
//                       ([code]) => code === region
//                     )?.[1].capital
//                   }
//                 </span>
...
//                 exit={{ opacity: 0, y: -10 }}
//                 className="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-lg py-1 text-base ring-1 ring-black ring-opacity-5 focus:outline-none max-h-60 overflow-auto"
//               >
//                 <RegionDropdown
//                   country="GH"
//                   value={region}
...
//                     ...region,
//                     name:
//                       ghanaRegionsData[region.value]?.capital || region.name,
//                   })}
//                 />
//                 <div className="py-1">
...
//                         <span className="font-medium">{data.capital}</span>
...
//           {errors.region && (
//             <p className="mt-1 text-sm text-red-600">Please select a region</p>
//           )}
//         </div>
...
//           <AnimatePresence>
//             {isCityOpen && region && filteredCities.length > 0 && (
//               <motion.div
//                 initial={{ opacity: 0, y: -10 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 exit={{ opacity: 0, y: -10 }}
...
//                   message: "Enter a valid Ghana postal code (e.g., GA123)",
//                 },
//               })}
//               className={`w-full px-4 py-3 rounded-lg border ${
...
//                   <span>{currentRegionData.area}</span>
//                 </div>
//                 <div>
//                   <span className="text-gray-500">Population:</span>{" "}
//                   <span>{currentRegionData.population}</span>
//                 </div>
//                 <div>
//                   <span className="text-gray-500">Major Cities:</span>{" "}
//                   <span>{currentRegionData.cities.slice(0, 3).join(", ")}</span>
//                 </div>
//               </div>
//             </div>
//           </div>
