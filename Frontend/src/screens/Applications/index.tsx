  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        hasPrefilledRef.current = false; // Allow prefilling again for new application
        hasShownToastRef.current = false; // Allow toast to show again for new application
      }, 2000);
    ...
    <div>
      <main className="overflow-y-auto p-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 mb-6 border border-indigo-200/50 dark:border-indigo-700/50">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-indigo-700 dark:text-indigo-300 text-sm mb-3">
                  Complete this application to get your personalized credit risk score. Our AI-powered system will analyze your information to determine your creditworthiness and loan eligibility.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-indigo-600 dark:text-indigo-400">Instant AI-powered risk assessment</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-indigo-600 dark:text-indigo-400">Secure document processing</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-indigo-600 dark:text-indigo-400">Personalized recommendations</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-indigo-600 dark:text-indigo-400">Bank-level encryption</span>
                  </div>
                </div>
              </div>
            </div>
