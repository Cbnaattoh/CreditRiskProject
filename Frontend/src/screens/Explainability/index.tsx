...
const PredictionExplainability: React.FC = () => {
  ...
  } = useGetRiskExplanationQuery(applicationId || '', { skip: !applicationId });
  
  const { 
    data: modelPredictions, 
    isLoading: predictionsLoading 
  } = useGetModelPredictionsQuery(applicationId || '', { skip: !applicationId });
  
  const { 
    data: counterfactuals, 
    isLoading: counterfactualsLoading 
  } = useGetCounterfactualExplanationsQuery(applicationId || '', { skip: !applicationId });
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Please select an application from the applications list to view explainability details.
            </p>
          </div>
        </div>
      </div>
