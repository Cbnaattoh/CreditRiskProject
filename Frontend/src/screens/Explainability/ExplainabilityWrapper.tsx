...
import { FiEye, FiUsers, FiSearch, FiArrowRight, FiTarget, FiCpu } from "react-icons/fi";
...
import ExplainabilityComponent from "./index";

const ExplainabilityWrapper: React.FC = () => {
  const [searchParams] = useSearchParams();
  const navigate = useNavigate();
  const applicationId = searchParams.get('id');
  const isClientUser = useIsClientUser();
  
  // If applicationId is provided, show the actual Explainability component
  if (applicationId) {
...
const ApplicationSelector: React.FC = () => {
  ...
  const handleSelectApplication = (appId: string) => {
    navigate(`/home/explainability?id=${appId}`);
  };
  
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-900 dark:to-purple-900 flex items-center justify-center">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-900 dark:to-purple-900 flex items-center justify-center">
        <div className="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md">
          <FiCpu className="mx-auto text-6xl text-gray-400 mb-4" />
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-900 dark:to-purple-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            <FiCpu className="text-2xl text-purple-600 dark:text-purple-400" />
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            {isClientUser 
              ? "Select one of your applications to understand how our AI made its decision"
              : "Select an application to view detailed AI decision explanations and model insights"
            }
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            />
          </div>
        </div>
            ...
            {applications.map((app, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <FiArrowRight className="text-purple-600 dark:text-purple-400 group-hover:translate-x-1 transition-transform duration-200" />
                </div>
              </motion.div>
            ))}
          </div>
...
export default ExplainabilityWrapper;