...
const useFormManagement = () => {
  ...
  return { loginMethods, mfaFormMethods, resetForms };
};
...
const Login: React.FC = () => {
  ...
  const { loginMethods, mfaFormMethods, resetForms } = useFormManagement();
        ...
        <div>
          ...
          <ul className="text-xs text-gray-500 mt-2 space-y-1">
            <li className="flex items-center">
              <FiCheck className="mr-1 text-green-500" /> At least 8 characters
            </li>
            <li className="flex items-center">
